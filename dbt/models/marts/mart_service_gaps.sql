...
-- models/marts/mart_service_gaps.sql
--
-- Service availability gaps per county.
-- Answers:
--   Which counties have fewer than 3 maternity facilities per 100k?
--   Where can a patient access ART services?
--   Which counties have no emergency care facilities at all?
-- ============================================================
